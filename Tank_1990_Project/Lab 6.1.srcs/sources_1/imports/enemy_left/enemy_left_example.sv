...
always_ff @ (posedge vga_clk) begin
	if( ((DrawX - enemy_X-2) <= enemy_S-2) && ((DrawY - enemy_Y) <= enemy_S-1) && (pink_flag == 1'b0) ) begin
...
enemy_left_rom enemy_left_rom (
	.clka   (negedge_vga_clk),
	.addra (rom_address),
	.douta       (rom_q)
);

enemy_left_palette enemy_left_palette (
	.index (rom_q),
	.red   (palette_red),
	.green (palette_green),
	.blue  (palette_blue)
